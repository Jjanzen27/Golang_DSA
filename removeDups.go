...
iven an integer array nums sorted in non-decreasing order, remove the
...
func main() {
	...
	fmt.Println(removeDuplicates([]int{0, 1, 1, 2, 2, 3, 3, 4, 5, 5}))
	fmt.Println(removeDuplicates([]int{0, 0, 1, 1, 1, 3, 3, 4}))
	fmt.Println(removeDuplicates([]int{0, 0, 1, 1, 1, 2, 2, 3, 3, 4, 7, 9, 9, 10}))
}
